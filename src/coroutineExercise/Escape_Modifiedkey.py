    ...
    def _cmd_hit(self, hit_args):
        if len(hit_args) == 0:
            ...
            if not object or not object["visible"]:
                ...
                hit_result = "It's already hit."

            elif object["hittable"]:
...
class EscapeRoomGame:
    ...
    def create_game(self, cheat=False):
        ...
        mirror = EscapeRoomObject("mirror", visible=True, hittable=False)
